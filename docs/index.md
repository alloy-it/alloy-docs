...
Browse [alloy-it.io](https://alloy-it.io) to find a blueprint for your toolchain or board. Note the blueprint name and version tag (e.g. `community/nordic/nrf91:1.1.3`, `community/raspberry-pi-arm64:1.0.0`).
...
Run the provisioner with your blueprint. Use the name from Alloy Hub in the form `<vendor>/<board>:version` (version is required).
